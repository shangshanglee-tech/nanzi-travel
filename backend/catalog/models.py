...
class Vessel(models.Model):
    ...
    is_hybrid = models.BooleanField("混合动力", default=False)
    has_science_center = models.BooleanField("科研中心", default=False)
    has_wifi = models.BooleanField("无线网络", default=False)
    has_stabilization_system = models.BooleanField("船身稳定技术", default=False)
    restaurant_count = models.PositiveSmallIntegerField("餐厅数量", default=0)
    bar_count = models.PositiveSmallIntegerField("酒吧数量", default=0)
    fitness_center_count = models.PositiveSmallIntegerField("健身中心", default=0)
    heated_pool_count = models.PositiveSmallIntegerField("恒温泳池", default=0)
    infinity_pool_count = models.PositiveSmallIntegerField("无边泳池", default=0)
    sauna_count = models.PositiveSmallIntegerField("桑拿房", default=0)
    executive_lounge_count = models.PositiveSmallIntegerField("行政酒廊", default=0)
